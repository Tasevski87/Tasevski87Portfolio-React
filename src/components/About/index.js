        ...
        <section className="my-5" >
            ...
            <div className="my-2">
                <p>
                    ...
                    Im born 10th of January 1987 in Veles, Republic of Macedonia. I went to college in city of Bitola to the University of Kliment Ohridski where i attned three year program of Computer Science where I studyed C++. June 5th 2008 I moved to the united states where first I lived and worked for the National Park Yellowstone. Later on I decide to move to Columbus Ohio where i met my wife. I always have pation towards programing so i decide to continue and upgrade my self. October 2021 I joined the Ohio State Cooding Bootcamp amd im studying to be a Full Stack Developer.
                </p>
